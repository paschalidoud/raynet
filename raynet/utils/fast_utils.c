...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [], 
        "name": "utils/fast_utils", 
        "sources": [
            "utils/fast_utils.pyx"
        ]
    }, 
    "module_name": "utils/fast_utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__raynet__utils__fast_utils
#define __PYX_HAVE_API__raynet__utils__fast_utils
#include <math.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'raynet.utils.fast_utils' */
...
static void __pyx_f_6raynet_5utils_10fast_utils_fast_cross_mm(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_6raynet_5utils_10fast_utils_fast_cross_vm(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE void __pyx_f_6raynet_5utils_10fast_utils_fast_cross_vv(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE void __pyx_f_6raynet_5utils_10fast_utils_sub(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static CYTHON_INLINE float __pyx_f_6raynet_5utils_10fast_utils_dot(__Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static PyArrayObject *__pyx_f_6raynet_5utils_10fast_utils_fast_ray_triangles_intersection(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
...
#define __Pyx_MODULE_NAME "raynet.utils.fast_utils"
extern int __pyx_module_is_main_raynet__utils__fast_utils;
int __pyx_module_is_main_raynet__utils__fast_utils = 0;

/* Implementation of 'raynet.utils.fast_utils' */
...
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_fast_cross_mm(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r); /* proto */
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_2fast_cross_vm(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r); /* proto */
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_4fast_cross_vv(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r); /* proto */
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_6fast_ray_triangles_intersection(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_origin, __Pyx_memviewslice __pyx_v_destination, __Pyx_memviewslice __pyx_v_p0, __Pyx_memviewslice __pyx_v_p1, __Pyx_memviewslice __pyx_v_p2); /* proto */
...
/* "raynet/utils/fast_utils.pyx":10
 * 
...
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_1fast_cross_mm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6raynet_5utils_10fast_utils_fast_cross_mm(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  int __pyx_v_i;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "raynet/utils/fast_utils.pyx":11
 * @cython.boundscheck(False)
 * cpdef void fast_cross_mm(float[:, :] a, float [:, :] b, float[:, :] r) nogil:
 *     cdef int N = r.shape[0]             # <<<<<<<<<<<<<<
 *     for i in range(N):
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":12
 * cpdef void fast_cross_mm(float[:, :] a, float [:, :] b, float[:, :] r) nogil:
 *     cdef int N = r.shape[0]
 *     for i in range(N):             # <<<<<<<<<<<<<<
 *         r[i, 0] = a[i, 1]*b[i, 2] - a[i, 2]*b[i, 1]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "raynet/utils/fast_utils.pyx":13
 *     cdef int N = r.shape[0]
 *     for i in range(N):
 *         r[i, 0] = a[i, 1]*b[i, 2] - a[i, 2]*b[i, 1]             # <<<<<<<<<<<<<<
 *         r[i, 1] = a[i, 2]*b[i, 0] - a[i, 0]*b[i, 2]
 ...
 */
    ...
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_b.shape[1];
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_8 = 2;
    ...
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_11 * __pyx_v_r.strides[0]) ) + __pyx_t_12 * __pyx_v_r.strides[1]) )) = (((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_3 * __pyx_v_a.strides[0]) ) + __pyx_t_4 * __pyx_v_a.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_5 * __pyx_v_b.strides[0]) ) + __pyx_t_6 * __pyx_v_b.strides[1]) )))) - ((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ) + __pyx_t_8 * __pyx_v_a.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_9 * __pyx_v_b.strides[0]) ) + __pyx_t_10 * __pyx_v_b.strides[1]) )))));

    /* "raynet/utils/fast_utils.pyx":14
 *     for i in range(N):
 *         r[i, 0] = a[i, 1]*b[i, 2] - a[i, 2]*b[i, 1]
 *         r[i, 1] = a[i, 2]*b[i, 0] - a[i, 0]*b[i, 2]             # <<<<<<<<<<<<<<
 *         r[i, 2] = a[i, 0]*b[i, 1] - a[i, 1]*b[i, 0]
 ...
 */
    ...
    if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_b.shape[1];
    ...
    __pyx_t_22 = 1;
    if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_r.shape[0];
    if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_v_r.shape[1];
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_21 * __pyx_v_r.strides[0]) ) + __pyx_t_22 * __pyx_v_r.strides[1]) )) = (((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_13 * __pyx_v_a.strides[0]) ) + __pyx_t_14 * __pyx_v_a.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_15 * __pyx_v_b.strides[0]) ) + __pyx_t_16 * __pyx_v_b.strides[1]) )))) - ((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_17 * __pyx_v_a.strides[0]) ) + __pyx_t_18 * __pyx_v_a.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_19 * __pyx_v_b.strides[0]) ) + __pyx_t_20 * __pyx_v_b.strides[1]) )))));

    /* "raynet/utils/fast_utils.pyx":15
 *         r[i, 0] = a[i, 1]*b[i, 2] - a[i, 2]*b[i, 1]
 *         r[i, 1] = a[i, 2]*b[i, 0] - a[i, 0]*b[i, 2]
 *         r[i, 2] = a[i, 0]*b[i, 1] - a[i, 1]*b[i, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_v_a.shape[1];
    __pyx_t_25 = __pyx_v_i;
    __pyx_t_26 = 1;
    if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_v_b.shape[0];
    if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_v_b.shape[1];
    __pyx_t_27 = __pyx_v_i;
    __pyx_t_28 = 1;
    if (__pyx_t_27 < 0) __pyx_t_27 += __pyx_v_a.shape[0];
    if (__pyx_t_28 < 0) __pyx_t_28 += __pyx_v_a.shape[1];
    __pyx_t_29 = __pyx_v_i;
    __pyx_t_30 = 0;
    if (__pyx_t_29 < 0) __pyx_t_29 += __pyx_v_b.shape[0];
    if (__pyx_t_30 < 0) __pyx_t_30 += __pyx_v_b.shape[1];
    __pyx_t_31 = __pyx_v_i;
    __pyx_t_32 = 2;
    if (__pyx_t_31 < 0) __pyx_t_31 += __pyx_v_r.shape[0];
    if (__pyx_t_32 < 0) __pyx_t_32 += __pyx_v_r.shape[1];
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_31 * __pyx_v_r.strides[0]) ) + __pyx_t_32 * __pyx_v_r.strides[1]) )) = (((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_23 * __pyx_v_a.strides[0]) ) + __pyx_t_24 * __pyx_v_a.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_25 * __pyx_v_b.strides[0]) ) + __pyx_t_26 * __pyx_v_b.strides[1]) )))) - ((*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_a.data + __pyx_t_27 * __pyx_v_a.strides[0]) ) + __pyx_t_28 * __pyx_v_a.strides[1]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_29 * __pyx_v_b.strides[0]) ) + __pyx_t_30 * __pyx_v_b.strides[1]) )))));
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_1fast_cross_mm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_1fast_cross_mm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_b = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("fast_cross_mm (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_r,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("fast_cross_mm", 1, 3, 3, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fast_cross_mm", 1, 3, 3, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fast_cross_mm") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[0]); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[1]); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[2]); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fast_cross_mm", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("raynet.utils.fast_utils.fast_cross_mm", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6raynet_5utils_10fast_utils_fast_cross_mm(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_r);
...
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_fast_cross_mm(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("fast_cross_mm", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_b.memview)) { __Pyx_RaiseUnboundLocalError("b"); __PYX_ERR(0, 10, __pyx_L1_error) }
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); __PYX_ERR(0, 10, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6raynet_5utils_10fast_utils_fast_cross_mm(__pyx_v_a, __pyx_v_b, __pyx_v_r, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
...
/* "raynet/utils/fast_utils.pyx":19
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_3fast_cross_vm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_6raynet_5utils_10fast_utils_fast_cross_vm(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  int __pyx_v_i;
  int __pyx_t_1;
  int __pyx_t_2;
  ...
  /* "raynet/utils/fast_utils.pyx":20
 * @cython.boundscheck(False)
 * cpdef void fast_cross_vm(float[:] a, float [:, :] b, float[:, :] r) nogil:
 *     cdef int N = r.shape[0]             # <<<<<<<<<<<<<<
 *     for i in range(N):
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":21
 * cpdef void fast_cross_vm(float[:] a, float [:, :] b, float[:, :] r) nogil:
 *     cdef int N = r.shape[0]
 *     for i in range(N):             # <<<<<<<<<<<<<<
 *         r[i, 0] = a[1]*b[i, 2] - a[2]*b[i, 1]
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "raynet/utils/fast_utils.pyx":22
 *     cdef int N = r.shape[0]
 *     for i in range(N):
 *         r[i, 0] = a[1]*b[i, 2] - a[2]*b[i, 1]             # <<<<<<<<<<<<<<
 *         r[i, 1] = a[2]*b[i, 0] - a[0]*b[i, 2]
 ...
 */
    ...
    if (__pyx_t_5 < 0) __pyx_t_5 += __pyx_v_b.shape[1];
    __pyx_t_6 = 2;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_a.shape[0];
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_8 = 1;
    if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_b.shape[0];
    if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_b.shape[1];
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_10 = 0;
    if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_r.shape[0];
    if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_r.shape[1];
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_9 * __pyx_v_r.strides[0]) ) + __pyx_t_10 * __pyx_v_r.strides[1]) )) = (((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_3 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) ) + __pyx_t_5 * __pyx_v_b.strides[1]) )))) - ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_6 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_7 * __pyx_v_b.strides[0]) ) + __pyx_t_8 * __pyx_v_b.strides[1]) )))));

    /* "raynet/utils/fast_utils.pyx":23
 *     for i in range(N):
 *         r[i, 0] = a[1]*b[i, 2] - a[2]*b[i, 1]
 *         r[i, 1] = a[2]*b[i, 0] - a[0]*b[i, 2]             # <<<<<<<<<<<<<<
 *         r[i, 2] = a[0]*b[i, 1] - a[1]*b[i, 0]
 ...
 */
    ...
    __pyx_t_17 = __pyx_v_i;
    __pyx_t_18 = 1;
    if (__pyx_t_17 < 0) __pyx_t_17 += __pyx_v_r.shape[0];
    if (__pyx_t_18 < 0) __pyx_t_18 += __pyx_v_r.shape[1];
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_17 * __pyx_v_r.strides[0]) ) + __pyx_t_18 * __pyx_v_r.strides[1]) )) = (((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_12 * __pyx_v_b.strides[0]) ) + __pyx_t_13 * __pyx_v_b.strides[1]) )))) - ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_14 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_15 * __pyx_v_b.strides[0]) ) + __pyx_t_16 * __pyx_v_b.strides[1]) )))));

    /* "raynet/utils/fast_utils.pyx":24
 *         r[i, 0] = a[1]*b[i, 2] - a[2]*b[i, 1]
 *         r[i, 1] = a[2]*b[i, 0] - a[0]*b[i, 2]
 *         r[i, 2] = a[0]*b[i, 1] - a[1]*b[i, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_25 = __pyx_v_i;
    __pyx_t_26 = 2;
    if (__pyx_t_25 < 0) __pyx_t_25 += __pyx_v_r.shape[0];
    if (__pyx_t_26 < 0) __pyx_t_26 += __pyx_v_r.shape[1];
    *((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_r.data + __pyx_t_25 * __pyx_v_r.strides[0]) ) + __pyx_t_26 * __pyx_v_r.strides[1]) )) = (((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_19 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_20 * __pyx_v_b.strides[0]) ) + __pyx_t_21 * __pyx_v_b.strides[1]) )))) - ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_22 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_b.data + __pyx_t_23 * __pyx_v_b.strides[0]) ) + __pyx_t_24 * __pyx_v_b.strides[1]) )))));
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_3fast_cross_vm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_3fast_cross_vm(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_b = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("fast_cross_vm (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_r,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("fast_cross_vm", 1, 3, 3, 1); __PYX_ERR(0, 19, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fast_cross_vm", 1, 3, 3, 2); __PYX_ERR(0, 19, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fast_cross_vm") < 0)) __PYX_ERR(0, 19, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0]); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[1]); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 19, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[2]); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 19, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fast_cross_vm", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 19, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("raynet.utils.fast_utils.fast_cross_vm", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6raynet_5utils_10fast_utils_2fast_cross_vm(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_r);
...
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_2fast_cross_vm(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("fast_cross_vm", 0);
  __Pyx_XDECREF(__pyx_r);
  ...
  if (unlikely(!__pyx_v_r.memview)) { __Pyx_RaiseUnboundLocalError("r"); __PYX_ERR(0, 19, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6raynet_5utils_10fast_utils_fast_cross_vm(__pyx_v_a, __pyx_v_b, __pyx_v_r, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "raynet/utils/fast_utils.pyx":28
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_5fast_cross_vv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE void __pyx_f_6raynet_5utils_10fast_utils_fast_cross_vv(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "raynet/utils/fast_utils.pyx":29
 * @cython.boundscheck(False)
 * cpdef inline void fast_cross_vv(float[:] a, float[:] b, float[:] r) nogil:
 *     r[0] = a[1]*b[2] - a[2]*b[1]             # <<<<<<<<<<<<<<
 *     r[1] = a[2]*b[0] - a[0]*b[2]
 ...
 */
  ...
  *((float *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_5 * __pyx_v_r.strides[0]) )) = (((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_2 * __pyx_v_b.strides[0]) )))) - ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_3 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_4 * __pyx_v_b.strides[0]) )))));

  /* "raynet/utils/fast_utils.pyx":30
 * cpdef inline void fast_cross_vv(float[:] a, float[:] b, float[:] r) nogil:
 *     r[0] = a[1]*b[2] - a[2]*b[1]
 *     r[1] = a[2]*b[0] - a[0]*b[2]             # <<<<<<<<<<<<<<
 *     r[2] = a[0]*b[1] - a[1]*b[0]
 ...
 */
  ...
  *((float *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_10 * __pyx_v_r.strides[0]) )) = (((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_6 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_7 * __pyx_v_b.strides[0]) )))) - ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_8 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_9 * __pyx_v_b.strides[0]) )))));

  /* "raynet/utils/fast_utils.pyx":31
 *     r[0] = a[1]*b[2] - a[2]*b[1]
 *     r[1] = a[2]*b[0] - a[0]*b[2]
 *     r[2] = a[0]*b[1] - a[1]*b[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  *((float *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_15 * __pyx_v_r.strides[0]) )) = (((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_11 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_12 * __pyx_v_b.strides[0]) )))) - ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_13 * __pyx_v_a.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_14 * __pyx_v_b.strides[0]) )))));
...
/* Python wrapper */
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_5fast_cross_vv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_5fast_cross_vv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_a = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_b = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("fast_cross_vv (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_r,0};
    PyObject* values[3] = {0,0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("fast_cross_vv", 1, 3, 3, 1); __PYX_ERR(0, 28, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_r)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fast_cross_vv", 1, 3, 3, 2); __PYX_ERR(0, 28, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fast_cross_vv") < 0)) __PYX_ERR(0, 28, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0]); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 28, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[1]); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 28, __pyx_L3_error)
    __pyx_v_r = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[2]); if (unlikely(!__pyx_v_r.memview)) __PYX_ERR(0, 28, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fast_cross_vv", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 28, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("raynet.utils.fast_utils.fast_cross_vv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6raynet_5utils_10fast_utils_4fast_cross_vv(__pyx_self, __pyx_v_a, __pyx_v_b, __pyx_v_r);
...
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_4fast_cross_vv(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("fast_cross_vv", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_a.memview)) { __Pyx_RaiseUnboundLocalError("a"); __PYX_ERR(0, 28, __pyx_L1_error) }
  ...
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_6raynet_5utils_10fast_utils_fast_cross_vv(__pyx_v_a, __pyx_v_b, __pyx_v_r, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "raynet/utils/fast_utils.pyx":35
 * 
 * @cython.boundscheck(False)
...
static CYTHON_INLINE void __pyx_f_6raynet_5utils_10fast_utils_sub(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b, __Pyx_memviewslice __pyx_v_r) {
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  Py_ssize_t __pyx_t_4;
  ...
  /* "raynet/utils/fast_utils.pyx":36
 * @cython.boundscheck(False)
 * cdef inline void sub(float[:] a, float[:] b, float[:] r) nogil:
 *     r[0] = a[0] - b[0]             # <<<<<<<<<<<<<<
 *     r[1] = a[1] - b[1]
 ...
 */
  ...
  *((float *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_3 * __pyx_v_r.strides[0]) )) = ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_1 * __pyx_v_a.strides[0]) ))) - (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_2 * __pyx_v_b.strides[0]) ))));

  /* "raynet/utils/fast_utils.pyx":37
 * cdef inline void sub(float[:] a, float[:] b, float[:] r) nogil:
 *     r[0] = a[0] - b[0]
 *     r[1] = a[1] - b[1]             # <<<<<<<<<<<<<<
 *     r[2] = a[2] - b[2]
 ...
 */
  ...
  *((float *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_6 * __pyx_v_r.strides[0]) )) = ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_4 * __pyx_v_a.strides[0]) ))) - (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_5 * __pyx_v_b.strides[0]) ))));

  /* "raynet/utils/fast_utils.pyx":38
 *     r[0] = a[0] - b[0]
 *     r[1] = a[1] - b[1]
 *     r[2] = a[2] - b[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_9 = 2;
  if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_r.shape[0];
  *((float *) ( /* dim=0 */ (__pyx_v_r.data + __pyx_t_9 * __pyx_v_r.strides[0]) )) = ((*((float *) ( /* dim=0 */ (__pyx_v_a.data + __pyx_t_7 * __pyx_v_a.strides[0]) ))) - (*((float *) ( /* dim=0 */ (__pyx_v_b.data + __pyx_t_8 * __pyx_v_b.strides[0]) ))));
...
/* "raynet/utils/fast_utils.pyx":42
 * 
 * @cython.boundscheck(False)
...
static CYTHON_INLINE float __pyx_f_6raynet_5utils_10fast_utils_dot(__Pyx_memviewslice __pyx_v_a, __Pyx_memviewslice __pyx_v_b) {
  float __pyx_r;
  Py_ssize_t __pyx_t_1;
  Py_ssize_t __pyx_t_2;
  Py_ssize_t __pyx_t_3;
  ...
  /* "raynet/utils/fast_utils.pyx":43
 * @cython.boundscheck(False)
 * cdef inline float dot(float[:] a, float[:] b) nogil:
 *     return a[0]*b[0] + a[1]*b[1] + a[2]*b[2]             # <<<<<<<<<<<<<<
 * 
...
/* "raynet/utils/fast_utils.pyx":47
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_7fast_ray_triangles_intersection(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_6raynet_5utils_10fast_utils_fast_ray_triangles_intersection(__Pyx_memviewslice __pyx_v_origin, __Pyx_memviewslice __pyx_v_destination, __Pyx_memviewslice __pyx_v_p0, __Pyx_memviewslice __pyx_v_p1, __Pyx_memviewslice __pyx_v_p2, CYTHON_UNUSED int __pyx_skip_dispatch) {
  float __pyx_v_ray_d[3];
  __Pyx_memviewslice __pyx_v_ray = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_norm;
  long __pyx_v_i;
  int __pyx_v_N;
  float __pyx_v_e1_d[3];
  float __pyx_v_e2_d[3];
  float __pyx_v_tvec_d[3];
  float __pyx_v_pvec_d[3];
  float __pyx_v_qvec_d[3];
  __Pyx_memviewslice __pyx_v_e1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_e2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_tvec = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_pvec = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_qvec = { 0, 0, { 0 }, { 0 }, { 0 } };
  float __pyx_v_det;
  float __pyx_v_inv_det;
  float __pyx_v_eps;
  float __pyx_v_u;
  float __pyx_v_v;
  float __pyx_v_t;
  ...
  Py_ssize_t __pyx_t_22;
  Py_ssize_t __pyx_t_23;
  __Pyx_RefNannySetupContext("fast_ray_triangles_intersection", 0);
  ...
  /* "raynet/utils/fast_utils.pyx":56
 ...
 */
  ...
  __pyx_t_1 = __pyx_array_new(__pyx_t_2, sizeof(float), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_ray_d);
  ...
  __pyx_v_ray = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "raynet/utils/fast_utils.pyx":57
 *     cdef float[3] ray_d
 *     cdef float[:] ray = ray_d
 *     cdef float norm = 0             # <<<<<<<<<<<<<<
 *     for i in range(3):
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":58
 *     cdef float[:] ray = ray_d
 *     cdef float norm = 0
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         ray[i] = destination[i] - origin[i]
 ...
 */
  for (__pyx_t_5 = 0; __pyx_t_5 < 3; __pyx_t_5+=1) {
    ...
    /* "raynet/utils/fast_utils.pyx":59
 *     cdef float norm = 0
 *     for i in range(3):
 *         ray[i] = destination[i] - origin[i]             # <<<<<<<<<<<<<<
 *     for i in range(3):
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_destination.shape[0];
    __pyx_t_7 = __pyx_v_i;
    if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_origin.shape[0];
    __pyx_t_8 = __pyx_v_i;
    if (__pyx_t_8 < 0) __pyx_t_8 += __pyx_v_ray.shape[0];
    *((float *) ( /* dim=0 */ (__pyx_v_ray.data + __pyx_t_8 * __pyx_v_ray.strides[0]) )) = ((*((float *) ( /* dim=0 */ (__pyx_v_destination.data + __pyx_t_6 * __pyx_v_destination.strides[0]) ))) - (*((float *) ( /* dim=0 */ (__pyx_v_origin.data + __pyx_t_7 * __pyx_v_origin.strides[0]) ))));
  }

  /* "raynet/utils/fast_utils.pyx":60
 *     for i in range(3):
 *         ray[i] = destination[i] - origin[i]
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         norm += ray[i]*ray[i]
 ...
 */
  for (__pyx_t_5 = 0; __pyx_t_5 < 3; __pyx_t_5+=1) {
    ...
    /* "raynet/utils/fast_utils.pyx":61
 *         ray[i] = destination[i] - origin[i]
 *     for i in range(3):
 *         norm += ray[i]*ray[i]             # <<<<<<<<<<<<<<
 *     norm = sqrt(norm)
 ...
 */
    __pyx_t_9 = __pyx_v_i;
    if (__pyx_t_9 < 0) __pyx_t_9 += __pyx_v_ray.shape[0];
    __pyx_t_10 = __pyx_v_i;
    if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_ray.shape[0];
    __pyx_v_norm = (__pyx_v_norm + ((*((float *) ( /* dim=0 */ (__pyx_v_ray.data + __pyx_t_9 * __pyx_v_ray.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_ray.data + __pyx_t_10 * __pyx_v_ray.strides[0]) )))));
  }

  /* "raynet/utils/fast_utils.pyx":62
 *     for i in range(3):
 *         norm += ray[i]*ray[i]
 *     norm = sqrt(norm)             # <<<<<<<<<<<<<<
 *     for i in range(3):
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":63
 *         norm += ray[i]*ray[i]
 *     norm = sqrt(norm)
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         ray[i] /= norm
 ...
 */
  for (__pyx_t_5 = 0; __pyx_t_5 < 3; __pyx_t_5+=1) {
    ...
    /* "raynet/utils/fast_utils.pyx":64
 *     norm = sqrt(norm)
 *     for i in range(3):
 *         ray[i] /= norm             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_11 = __pyx_v_i;
    if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_ray.shape[0];
    *((float *) ( /* dim=0 */ (__pyx_v_ray.data + __pyx_t_11 * __pyx_v_ray.strides[0]) )) /= __pyx_v_norm;
  }

  /* "raynet/utils/fast_utils.pyx":67
 * 
 *     # Start the main ray intersection algorithm (see Moeller & Trumbore 1997)
 ...
 *     cdef float[3] e2_d
 */
  __pyx_v_N = (__pyx_v_p0.shape[0]);

  /* "raynet/utils/fast_utils.pyx":73
 *     cdef float[3] pvec_d
 *     cdef float[3] qvec_d
 *     cdef float[:] e1 = e1_d             # <<<<<<<<<<<<<<
 *     cdef float[:] e2 = e2_d
 ...
 */
  ...
  if (unlikely(!__pyx_t_2 || !__pyx_t_3 || !PyBytes_AsString(__pyx_t_2))) __PYX_ERR(0, 73, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __pyx_array_new(__pyx_t_3, sizeof(float), PyBytes_AS_STRING(__pyx_t_2), (char *) "fortran", (char *) __pyx_v_e1_d);
  ...
  /* "raynet/utils/fast_utils.pyx":74
 *     cdef float[3] qvec_d
 *     cdef float[:] e1 = e1_d
 *     cdef float[:] e2 = e2_d             # <<<<<<<<<<<<<<
 *     cdef float[:] tvec = tvec_d
 ...
 */
  __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_float);
  __pyx_t_2 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3));
  if (unlikely(!__pyx_t_3 || !__pyx_t_2 || !PyBytes_AsString(__pyx_t_3))) __PYX_ERR(0, 74, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __pyx_array_new(__pyx_t_2, sizeof(float), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_e2_d);
  ...
  /* "raynet/utils/fast_utils.pyx":75
 *     cdef float[:] e1 = e1_d
 *     cdef float[:] e2 = e2_d
 *     cdef float[:] tvec = tvec_d             # <<<<<<<<<<<<<<
 *     cdef float[:] pvec = pvec_d
 ...
 */
  __pyx_t_2 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_float);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3));
  if (unlikely(!__pyx_t_2 || !__pyx_t_3 || !PyBytes_AsString(__pyx_t_2))) __PYX_ERR(0, 75, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __pyx_array_new(__pyx_t_3, sizeof(float), PyBytes_AS_STRING(__pyx_t_2), (char *) "fortran", (char *) __pyx_v_tvec_d);
  ...
  /* "raynet/utils/fast_utils.pyx":76
 *     cdef float[:] e2 = e2_d
 *     cdef float[:] tvec = tvec_d
 *     cdef float[:] pvec = pvec_d             # <<<<<<<<<<<<<<
 *     cdef float[:] qvec = qvec_d
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = __pyx_array_new(__pyx_t_2, sizeof(float), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_pvec_d);
  ...
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __pyx_v_pvec = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "raynet/utils/fast_utils.pyx":77
 *     cdef float[:] tvec = tvec_d
 *     cdef float[:] pvec = pvec_d
 *     cdef float[:] qvec = qvec_d             # <<<<<<<<<<<<<<
 *     cdef float det, inv_det, eps=1e-6, u, v, t
 ...
 */
  __pyx_t_2 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_float);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3));
  if (unlikely(!__pyx_t_2 || !__pyx_t_3 || !PyBytes_AsString(__pyx_t_2))) __PYX_ERR(0, 77, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = __pyx_array_new(__pyx_t_3, sizeof(float), PyBytes_AS_STRING(__pyx_t_2), (char *) "fortran", (char *) __pyx_v_qvec_d);
  ...
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __pyx_v_qvec = __pyx_t_4;
  __pyx_t_4.memview = NULL;
  __pyx_t_4.data = NULL;

  /* "raynet/utils/fast_utils.pyx":78
 *     cdef float[:] pvec = pvec_d
 *     cdef float[:] qvec = qvec_d
 *     cdef float det, inv_det, eps=1e-6, u, v, t             # <<<<<<<<<<<<<<
 *     cdef cnp.ndarray[cnp.float32_t, ndim=2] results = \
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":80
 *     cdef float det, inv_det, eps=1e-6, u, v, t
 *     cdef cnp.ndarray[cnp.float32_t, ndim=2] results = \
 *         np.empty(shape=(100, 3), dtype=np.float32)             # <<<<<<<<<<<<<<
 *     cdef int rs_cnt = 0
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_shape, __pyx_tuple_) < 0) __PYX_ERR(0, 80, __pyx_L1_error)
  __pyx_t_12 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_12, __pyx_n_s_float32); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_13) < 0) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
  __pyx_t_13 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_empty_tuple, __pyx_t_2); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 80, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_14 = ((PyArrayObject *)__pyx_t_13);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_results.rcbuffer->pybuffer, (PyObject*)__pyx_t_14, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_14 = 0;
  __pyx_v_results = ((PyArrayObject *)__pyx_t_13);
  __pyx_t_13 = 0;

  /* "raynet/utils/fast_utils.pyx":81
 *     cdef cnp.ndarray[cnp.float32_t, ndim=2] results = \
 *         np.empty(shape=(100, 3), dtype=np.float32)
 *     cdef int rs_cnt = 0             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":82
 *         np.empty(shape=(100, 3), dtype=np.float32)
 *     cdef int rs_cnt = 0
 *     with nogil:             # <<<<<<<<<<<<<<
 *         for i in range(N):
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "raynet/utils/fast_utils.pyx":83
 *     cdef int rs_cnt = 0
 *     with nogil:
 *         for i in range(N):             # <<<<<<<<<<<<<<
 *             # Calculate the edges sharing the first point
 ...
 */
        ...
        for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_15; __pyx_t_5+=1) {
          ...
          /* "raynet/utils/fast_utils.pyx":85
 *         for i in range(N):
 *             # Calculate the edges sharing the first point
 *             sub(p1[i], p0[i], e1)             # <<<<<<<<<<<<<<
 *             sub(p2[i], p0[i], e2)
 * 
 */
          __pyx_t_4.data = __pyx_v_p1.data;
          __pyx_t_4.memview = __pyx_v_p1.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_4, 0);
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_p1.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_p1.strides[0];
...
__pyx_t_4.shape[0] = __pyx_v_p1.shape[1];
__pyx_t_4.strides[0] = __pyx_v_p1.strides[1];
...
__pyx_t_16.data = __pyx_v_p0.data;
          ...
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_p0.shape[0];
...
__pyx_t_16.shape[0] = __pyx_v_p0.shape[1];
__pyx_t_16.strides[0] = __pyx_v_p0.strides[1];
    __pyx_t_16.suboffsets[0] = -1;

__pyx_f_6raynet_5utils_10fast_utils_sub(__pyx_t_4, __pyx_t_16, __pyx_v_e1);
          ...
          /* "raynet/utils/fast_utils.pyx":86
 *             # Calculate the edges sharing the first point
 *             sub(p1[i], p0[i], e1)
 *             sub(p2[i], p0[i], e2)             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_t_16.data = __pyx_v_p2.data;
          __pyx_t_16.memview = __pyx_v_p2.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_16, 0);
          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_p2.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_p2.strides[0];
    if (1 && (__pyx_tmp_idx < 0))
        __pyx_tmp_idx += __pyx_tmp_shape;
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
            #ifdef WITH_THREAD
...
__pyx_t_16.shape[0] = __pyx_v_p2.shape[1];
__pyx_t_16.strides[0] = __pyx_v_p2.strides[1];
    __pyx_t_16.suboffsets[0] = -1;
...
__pyx_f_6raynet_5utils_10fast_utils_sub(__pyx_t_16, __pyx_t_4, __pyx_v_e2);
          __PYX_XDEC_MEMVIEW(&__pyx_t_16, 0);
          __pyx_t_16.memview = NULL;
          __pyx_t_16.data = NULL;
          __PYX_XDEC_MEMVIEW(&__pyx_t_4, 0);
          ...
          /* "raynet/utils/fast_utils.pyx":89
 * 
 *             # Calculate the determinant saving pvec for later use
 ...
 * 
 */
          __pyx_f_6raynet_5utils_10fast_utils_fast_cross_vv(__pyx_v_ray, __pyx_v_e2, __pyx_v_pvec, 0);

          /* "raynet/utils/fast_utils.pyx":90
 *             # Calculate the determinant saving pvec for later use
 *             fast_cross_vv(ray, e2, pvec)
 *             det = dot(e1, pvec)             # <<<<<<<<<<<<<<
 * 
 ...
 */
          __pyx_v_det = __pyx_f_6raynet_5utils_10fast_utils_dot(__pyx_v_e1, __pyx_v_pvec);

          /* "raynet/utils/fast_utils.pyx":93
 * 
 *             # If the determinant is 0 then the ray is parallel to the plane
 *             if -eps < det < eps:             # <<<<<<<<<<<<<<
 *                 continue
 *             inv_det = 1.0 / det
 */
          __pyx_t_17 = ((-__pyx_v_eps) < __pyx_v_det);
          if (__pyx_t_17) {
            __pyx_t_17 = (__pyx_v_det < __pyx_v_eps);
          }
          __pyx_t_18 = (__pyx_t_17 != 0);
          if (__pyx_t_18) {

            /* "raynet/utils/fast_utils.pyx":94
 *             # If the determinant is 0 then the ray is parallel to the plane
 *             if -eps < det < eps:
 *                 continue             # <<<<<<<<<<<<<<
 *             inv_det = 1.0 / det
 ...
 */
          ...
          /* "raynet/utils/fast_utils.pyx":95
 *             if -eps < det < eps:
 *                 continue
 *             inv_det = 1.0 / det             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "raynet/utils/fast_utils.pyx":98
 * 
 *             # Calculate U saving tvec for later
 ...
 */
    ...
    if (0 && (__pyx_tmp_idx < 0 || __pyx_tmp_idx >= __pyx_tmp_shape)) {
        ...
        PyErr_SetString(PyExc_IndexError, "Index out of bounds (axis 0)");
            ...
            PyGILState_Release(__pyx_gilstate_save);
            #endif
        __PYX_ERR(0, 98, __pyx_L10_error)
    }
        __pyx_t_4.data += __pyx_tmp_idx * __pyx_tmp_stride;
}
...
__pyx_f_6raynet_5utils_10fast_utils_sub(__pyx_v_origin, __pyx_t_4, __pyx_v_tvec);
          __PYX_XDEC_MEMVIEW(&__pyx_t_4, 0);
          __pyx_t_4.memview = NULL;
          __pyx_t_4.data = NULL;

          /* "raynet/utils/fast_utils.pyx":99
 *             # Calculate U saving tvec for later
 *             sub(origin, p0[i], tvec)
 *             u = dot(tvec, pvec) * inv_det             # <<<<<<<<<<<<<<
 *             if u < 0 or u > 1:
 *                 continue
 */
          __pyx_v_u = (__pyx_f_6raynet_5utils_10fast_utils_dot(__pyx_v_tvec, __pyx_v_pvec) * __pyx_v_inv_det);

          /* "raynet/utils/fast_utils.pyx":100
 *             sub(origin, p0[i], tvec)
 *             u = dot(tvec, pvec) * inv_det
 *             if u < 0 or u > 1:             # <<<<<<<<<<<<<<
 *                 continue
 * 
 */
          __pyx_t_17 = ((__pyx_v_u < 0.0) != 0);
          if (!__pyx_t_17) {
          } else {
            __pyx_t_18 = __pyx_t_17;
            goto __pyx_L16_bool_binop_done;
          }
          __pyx_t_17 = ((__pyx_v_u > 1.0) != 0);
          __pyx_t_18 = __pyx_t_17;
          __pyx_L16_bool_binop_done:;
          if (__pyx_t_18) {

            /* "raynet/utils/fast_utils.pyx":101
 *             u = dot(tvec, pvec) * inv_det
 *             if u < 0 or u > 1:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "raynet/utils/fast_utils.pyx":104
 * 
 *             # Calculate V
 ...
 *             if v < 0 or u + v > 1:
 */
          __pyx_f_6raynet_5utils_10fast_utils_fast_cross_vv(__pyx_v_tvec, __pyx_v_e1, __pyx_v_qvec, 0);

          /* "raynet/utils/fast_utils.pyx":105
 *             # Calculate V
 *             fast_cross_vv(tvec, e1, qvec)
 *             v = dot(ray, qvec) * inv_det             # <<<<<<<<<<<<<<
 *             if v < 0 or u + v > 1:
 *                 continue
 */
          __pyx_v_v = (__pyx_f_6raynet_5utils_10fast_utils_dot(__pyx_v_ray, __pyx_v_qvec) * __pyx_v_inv_det);

          /* "raynet/utils/fast_utils.pyx":106
 *             fast_cross_vv(tvec, e1, qvec)
 *             v = dot(ray, qvec) * inv_det
 *             if v < 0 or u + v > 1:             # <<<<<<<<<<<<<<
 *                 continue
 * 
 */
          __pyx_t_17 = ((__pyx_v_v < 0.0) != 0);
          if (!__pyx_t_17) {
          } else {
            __pyx_t_18 = __pyx_t_17;
            goto __pyx_L19_bool_binop_done;
          }
          __pyx_t_17 = (((__pyx_v_u + __pyx_v_v) > 1.0) != 0);
          __pyx_t_18 = __pyx_t_17;
          __pyx_L19_bool_binop_done:;
          if (__pyx_t_18) {

            /* "raynet/utils/fast_utils.pyx":107
 *             v = dot(ray, qvec) * inv_det
 *             if v < 0 or u + v > 1:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
          ...
          /* "raynet/utils/fast_utils.pyx":110
 * 
 *             # Calculate T to find the intersection point
 ...
 */
          __pyx_v_t = (__pyx_f_6raynet_5utils_10fast_utils_dot(__pyx_v_e2, __pyx_v_qvec) * __pyx_v_inv_det);

          /* "raynet/utils/fast_utils.pyx":111
 *             # Calculate T to find the intersection point
 *             t = dot(e2, qvec) * inv_det
 *             for i in range(3):             # <<<<<<<<<<<<<<
 *                 results[rs_cnt, i] = origin[i] + t * ray[i]
 ...
 */
          for (__pyx_t_19 = 0; __pyx_t_19 < 3; __pyx_t_19+=1) {
            ...
            /* "raynet/utils/fast_utils.pyx":112
 *             t = dot(e2, qvec) * inv_det
 *             for i in range(3):
 *                 results[rs_cnt, i] = origin[i] + t * ray[i]             # <<<<<<<<<<<<<<
 *             rs_cnt += 1
 ...
 */
            __pyx_t_20 = __pyx_v_i;
            if (__pyx_t_20 < 0) __pyx_t_20 += __pyx_v_origin.shape[0];
            __pyx_t_21 = __pyx_v_i;
            if (__pyx_t_21 < 0) __pyx_t_21 += __pyx_v_ray.shape[0];
            __pyx_t_22 = __pyx_v_rs_cnt;
            __pyx_t_23 = __pyx_v_i;
            if (__pyx_t_22 < 0) __pyx_t_22 += __pyx_pybuffernd_results.diminfo[0].shape;
            if (__pyx_t_23 < 0) __pyx_t_23 += __pyx_pybuffernd_results.diminfo[1].shape;
            *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_results.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_results.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_results.diminfo[1].strides) = ((*((float *) ( /* dim=0 */ (__pyx_v_origin.data + __pyx_t_20 * __pyx_v_origin.strides[0]) ))) + (__pyx_v_t * (*((float *) ( /* dim=0 */ (__pyx_v_ray.data + __pyx_t_21 * __pyx_v_ray.strides[0]) )))));
          }

          /* "raynet/utils/fast_utils.pyx":113
 *             for i in range(3):
 *                 results[rs_cnt, i] = origin[i] + t * ray[i]
 *             rs_cnt += 1             # <<<<<<<<<<<<<<
 *             if rs_cnt >= 100:
 *                 break
 */
          __pyx_v_rs_cnt = (__pyx_v_rs_cnt + 1);

          /* "raynet/utils/fast_utils.pyx":114
 *                 results[rs_cnt, i] = origin[i] + t * ray[i]
 *             rs_cnt += 1
 *             if rs_cnt >= 100:             # <<<<<<<<<<<<<<
 *                 break
 * 
 */
          __pyx_t_18 = ((__pyx_v_rs_cnt >= 0x64) != 0);
          if (__pyx_t_18) {

            /* "raynet/utils/fast_utils.pyx":115
 *             rs_cnt += 1
 *             if rs_cnt >= 100:
 *                 break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "raynet/utils/fast_utils.pyx":117
 *                 break
 * 
 *     return results[:rs_cnt]             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_rs_cnt); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __pyx_t_2 = PySlice_New(Py_None, __pyx_t_13, Py_None); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
  __pyx_t_13 = PyObject_GetItem(((PyObject *)__pyx_v_results), __pyx_t_2); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 117, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("raynet.utils.fast_utils.fast_ray_triangles_intersection", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_results.rcbuffer->pybuffer);
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_e2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_tvec, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_pvec, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_qvec, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_7fast_ray_triangles_intersection(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6raynet_5utils_10fast_utils_7fast_ray_triangles_intersection(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("fast_ray_triangles_intersection (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_origin,&__pyx_n_s_destination,&__pyx_n_s_p0,&__pyx_n_s_p1,&__pyx_n_s_p2,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_destination)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("fast_ray_triangles_intersection", 1, 5, 5, 1); __PYX_ERR(0, 47, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_p0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fast_ray_triangles_intersection", 1, 5, 5, 2); __PYX_ERR(0, 47, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_p1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fast_ray_triangles_intersection", 1, 5, 5, 3); __PYX_ERR(0, 47, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_p2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fast_ray_triangles_intersection", 1, 5, 5, 4); __PYX_ERR(0, 47, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fast_ray_triangles_intersection") < 0)) __PYX_ERR(0, 47, __pyx_L3_error)
      }
    ...
    __pyx_v_origin = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0]); if (unlikely(!__pyx_v_origin.memview)) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_destination = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[1]); if (unlikely(!__pyx_v_destination.memview)) __PYX_ERR(0, 49, __pyx_L3_error)
    __pyx_v_p0 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[2]); if (unlikely(!__pyx_v_p0.memview)) __PYX_ERR(0, 50, __pyx_L3_error)
    __pyx_v_p1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[3]); if (unlikely(!__pyx_v_p1.memview)) __PYX_ERR(0, 51, __pyx_L3_error)
    __pyx_v_p2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[4]); if (unlikely(!__pyx_v_p2.memview)) __PYX_ERR(0, 52, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fast_ray_triangles_intersection", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 47, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("raynet.utils.fast_utils.fast_ray_triangles_intersection", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6raynet_5utils_10fast_utils_6fast_ray_triangles_intersection(__pyx_self, __pyx_v_origin, __pyx_v_destination, __pyx_v_p0, __pyx_v_p1, __pyx_v_p2);
...
static PyObject *__pyx_pf_6raynet_5utils_10fast_utils_6fast_ray_triangles_intersection(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_origin, __Pyx_memviewslice __pyx_v_destination, __Pyx_memviewslice __pyx_v_p0, __Pyx_memviewslice __pyx_v_p1, __Pyx_memviewslice __pyx_v_p2) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("fast_ray_triangles_intersection", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_origin.memview)) { __Pyx_RaiseUnboundLocalError("origin"); __PYX_ERR(0, 47, __pyx_L1_error) }
  if (unlikely(!__pyx_v_destination.memview)) { __Pyx_RaiseUnboundLocalError("destination"); __PYX_ERR(0, 47, __pyx_L1_error) }
  if (unlikely(!__pyx_v_p0.memview)) { __Pyx_RaiseUnboundLocalError("p0"); __PYX_ERR(0, 47, __pyx_L1_error) }
  if (unlikely(!__pyx_v_p1.memview)) { __Pyx_RaiseUnboundLocalError("p1"); __PYX_ERR(0, 47, __pyx_L1_error) }
  if (unlikely(!__pyx_v_p2.memview)) { __Pyx_RaiseUnboundLocalError("p2"); __PYX_ERR(0, 47, __pyx_L1_error) }
  __pyx_t_1 = ((PyObject *)__pyx_f_6raynet_5utils_10fast_utils_fast_ray_triangles_intersection(__pyx_v_origin, __pyx_v_destination, __pyx_v_p0, __pyx_v_p1, __pyx_v_p2, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 * 
 */
      __pyx_t_3 = PyNumber_Add(__pyx_v_part, __pyx_kp_b__32); if (unlikely(!__pyx_t_3)) __PYX_ERR(2, 1467, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Add(__pyx_t_6, __pyx_kp_b__32); if (unlikely(!__pyx_t_5)) __PYX_ERR(2, 1467, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = PyNumber_Add(__pyx_t_5, __pyx_kp_b__33); if (unlikely(!__pyx_t_6)) __PYX_ERR(2, 1470, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *             result = fmt.string
 */
      __pyx_t_6 = PyUnicode_Join(__pyx_kp_u__34, __pyx_v_extents); if (unlikely(!__pyx_t_6)) __PYX_ERR(2, 1475, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "raynet.utils.fast_utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "raynet.utils.fast_utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "raynet.utils.fast_utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "raynet.utils.fast_utils._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"fast_cross_mm", (PyCFunction)__pyx_pw_6raynet_5utils_10fast_utils_1fast_cross_mm, METH_VARARGS|METH_KEYWORDS, 0},
  {"fast_cross_vm", (PyCFunction)__pyx_pw_6raynet_5utils_10fast_utils_3fast_cross_vm, METH_VARARGS|METH_KEYWORDS, 0},
  {"fast_cross_vv", (PyCFunction)__pyx_pw_6raynet_5utils_10fast_utils_5fast_cross_vv, METH_VARARGS|METH_KEYWORDS, 0},
  {"fast_ray_triangles_intersection", (PyCFunction)__pyx_pw_6raynet_5utils_10fast_utils_7fast_ray_triangles_intersection, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
 ...
 *     with nogil:
 */
  __pyx_tuple_ = PyTuple_Pack(2, __pyx_int_100, __pyx_int_3); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 80, __pyx_L1_error)
...
static int __pyx_pymod_exec_fast_utils(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  if (__pyx_module_is_main_raynet__utils__fast_utils) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "raynet.utils.fast_utils")) {
      if (unlikely(PyDict_SetItemString(modules, "raynet.utils.fast_utils", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init raynet.utils.fast_utils", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init raynet.utils.fast_utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
